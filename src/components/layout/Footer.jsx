...
export default function Footer() {
  ...
  return (
    <motion.footer
      ...
      whileInView="visible"
      viewport={{ once: true }}
      className="relative mt-1 sm:mt-2 md:mt-2 lg:mt-2 bg-gradient-to-b from-white/40 to-white/20 backdrop-blur-xs border-t border-white/30 footer-uniform-text"
    >
      {/* Content */}
      <Container className="relative content-maxwidth">
        {/* Top accent line */}
        <div className="h-px bg-gradient-to-r from-transparent via-brand-orange/40 to-transparent mb-0.5 sm:mb-1" />

        {/* Main Footer Content */}
        <div className="pt-0">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-1 sm:gap-1.5 md:gap-2 lg:gap-3 mb-0.5 sm:mb-1">
            {/* Company Info */}
            <motion.div
            ...
            >
              <h3 className="text-label mb-0.5 sm:mb-1 text-black tracking-wide">
                {SITE_CONTENT.company.name}
              </h3>
              <div className="h-1 w-8 sm:w-10 bg-gradient-to-r from-brand-orange to-orange-500 mb-0.5 sm:mb-1 rounded-full" />
              <p className="hidden sm:block text-body-xs text-black leading-tight mb-1.5 sm:mb-2">
              ...
              <div className="flex items-center gap-1 sm:gap-1.5">
                ...
                <motion.a
                  ...
                  aria-label="LinkedIn"
                >
                  <Linkedin className="w-4 h-4 sm:w-5 sm:h-5 text-brand-orange" />
                </motion.a>
              </div>
            </motion.div>
            ...
            <motion.div
              ...
              transition={{ duration: 0.3 }}
            >
              <h4 className="text-label mb-0.5 sm:mb-1 uppercase text-black">
                {SITE_CONTENT.footer.sections.navigation.title}
              </h4>
              <div className="h-1 w-8 sm:w-10 bg-gradient-to-r from-brand-orange to-orange-500 mb-0.5 sm:mb-1 rounded-full" />
              <nav className="flex flex-col gap-0.5 sm:gap-1 md:gap-1.5">
            ...
            <motion.div
              ...
              transition={{ duration: 0.3 }}
            >
              <h4 className="text-xs sm:text-sm font-bold mb-0.5 sm:mb-1 uppercase tracking-widest text-black">
        ...
        {/* Bottom Footer */}
        <div className="py-0">
          <div className="flex flex-col gap-0.25 sm:gap-0.5 text-center">
            ...
            <div className="flex items-center justify-center gap-0.5 sm:gap-0.5 text-label text-black flex-wrap">
